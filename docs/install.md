...
<div class="section-card">
  ...
  <div class="steps-grid">
    <div class="step-card">
      ...
      <p>That repo-aware start surface should stay light: one calm repo-context line, direct task suggestions, detected entrypoints, and fallback commands only when they actually help.</p>
