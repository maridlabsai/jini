...
<div class="section-card">
  ...
  <div class="steps-grid">
    <div class="step-card">
      ...
      <p>That repo-aware start surface should stay light: one calm repo-context line, direct task suggestions, a plain list of useful commands Jini found in the repo, and at most one quiet adoption hint for existing Jini work.</p>
