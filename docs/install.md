...
<div class="section-card">
  ...
  <div class="steps-grid">
    <div class="step-card">
      ...
      <p>The three starter suggestions should stay brief and action-first: <code>Review the repo and suggest the next move.</code>, <code>Fix the failing tests in this repo.</code>, and <code>Plan the change before editing.</code></p>
