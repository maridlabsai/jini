...
<div class="section-card">
  ...
  <div class="steps-grid">
    <div class="step-card">
      ...
      <p>When there is no repo context and no existing Jini work, the fallback should stay concise there too: tell the user to run <code>jini</code> from the repo or folder that needs work, and stop there instead of surfacing diagnostics or adoption guidance on first contact.</p>
