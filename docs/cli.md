...
<pre><code class="language-bash">jini</code></pre>
  ...
  <p>That repo-aware start surface should stay light: one calm repo-context line, direct task suggestions, one or two useful commands Jini found in the repo, and at most one quiet adoption hint for existing Jini work.</p>
