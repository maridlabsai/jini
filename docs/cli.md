...
<pre><code class="language-bash">jini</code></pre>
  ...
  <p>In a real terminal, bare <code>jini</code> should not print a launcher card and exit. It should stay open, detect the repo, ask <code>What do you want Jini to do?</code>, and accept the first task line immediately.</p>
