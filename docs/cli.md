...
<pre><code class="language-bash">jini</code></pre>
  ...
  <p>That repo-aware start surface should stay light: one calm repo-context line, direct task suggestions, detected entrypoints, and fallback commands only when they help.</p>
