...
| --- | --- | --- | --- |
| Homepage | In progress | Product landing now leads with decision framing, pricing promise, tested proof, a stronger shared visual system, packet-fed surface badges/status, and a less stale rollout voice | Add public links to live release packets when public downloads actually exist |
...
| Install page | In progress | CLI install is clear and the availability matrix now comes from a sanitized commercial surface snapshot instead of repeated preview copy | Add public links to live release packets when public downloads actually exist |
