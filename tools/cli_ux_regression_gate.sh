...
FOCUSED_TEST_PATTERN='TestInteractiveLocalTextEditAppendsQuotedLineInsteadOfDrafting|TestCurrentWorkLocalTextEditExecutesWithoutStartPrompt|TestCurrentWorkSimpleFactualQuestionAnswersDirectly|TestCurrentWorkCapitalQuestionAcceptsNaturalPhrasing|TestDirectArgsSimpleFactualQuestionAnswersDirectly|TestInteractiveSimpleFactualQuestionAnswersDirectlyWithoutCurrentWork|TestInteractiveMalformedCapitalQuestionCorrectsWithoutTravelFlow|TestInteractiveBareEntityAsksForIntentWithoutCreatingWork|TestInteractiveExplicitTripChoiceCanUseBareDestination|TestCurrentWorkMalformedCapitalQuestionCorrectsDirectly|TestCurrentWorkUnknownStandaloneQuestionStaysCompact|TestInteractiveLauncherHandlesUnsureInputWithUsefulPass|TestLauncherStartsAsCompactShellWhenCurrentWorkExists|TestCurrentWorkInteractiveLauncherIsCompactByDefault|TestLauncherShowsOtherActiveWorkWhenMultipleProjectsExist|TestInteractiveLauncherCanResumeNamedActiveProject|TestPublicDocsUseCurrentFirstRunFlow|TestP1SimplicityPriorityCoversCommandsSkillsAndAgents'
...
questions, malformed questions, bare entities, and generic fallback tasks must
not regress into template routing, draft/status frames, Start/Keep choices, or
