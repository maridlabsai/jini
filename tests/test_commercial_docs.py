...
class CommercialDocsTests(unittest.TestCase):
    ...
    def test_commercial_page_states_open_downloads_and_paid_optimizer(self) -> None:
        ...
        for marker in (
            ...
            "Route Autopilot after the planned 30-day free trial when checkout is live",
            "Token Savings Ledger after the planned 30-day free trial when checkout is live",
