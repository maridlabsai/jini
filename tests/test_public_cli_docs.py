...
class PublicCliDocsTests(unittest.TestCase):
    ...
    def test_cli_guide_promotes_commands_as_public_catalog(self) -> None:
        ...
        for marker in (
            ...
            "That repo-aware start surface should stay light: one calm repo-context line, direct task suggestions, a plain list of useful commands Jini found in the repo, and at most one quiet adoption hint for existing Jini work.",
