...
class PublicCliDocsTests(unittest.TestCase):
    ...
    def test_cli_guide_promotes_commands_as_public_catalog(self) -> None:
        ...
        for marker in (
            ...
            "Run this from the repo that needs work.",
            ...
            "Outside a repo, the same direct task ask should stay concise too: acknowledge the task, then tell the user to run it from a repo or adopt existing Jini work.",
    ...
    def test_install_page_uses_same_public_vs_admin_boundary(self) -> None:
        ...
        for marker in (
            ...
            "<code>status</code>, <code>continue</code>, <code>open</code>, and <code>doctor</code>",
            "When someone types a direct task outside a repo, Jini should stay concise there too: acknowledge the task, tell them to run it from the repo that needs work, and stop there.",
