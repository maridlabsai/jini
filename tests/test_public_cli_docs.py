...
class PublicCliDocsTests(unittest.TestCase):
    ...
    def test_cli_guide_promotes_commands_as_public_catalog(self) -> None:
        ...
        for marker in (
            ...
            "That repo-aware start surface should stay light: one calm repo-context line, direct task suggestions, detected entrypoints, and fallback commands only when they help.",
    ...
    def test_install_page_uses_same_public_vs_admin_boundary(self) -> None:
        ...
        for marker in (
            ...
            "jini fix failing tests",
            "jini plan this change",
            "That repo-aware start surface should stay light: one calm repo-context line, direct task suggestions, detected entrypoints, and fallback commands only when they actually help.",
            "show one calm repo-context line",
            "What do you want Jini to do?",
            "jini&gt;</code> prompt",
