...
Competitor watching is a P0 feature-selection loop. It must decide which
features to build next, which commodity surfaces to integrate, which ideas to
watch, which requirements to reject, and which existing requirements to delete.
...
1. Competitive watch packet.
   ...
   - Each packet nominates next feature candidates and deletion candidates for
     the release train, with a reason tied to a replacement-critical claim.
...
8. Compounding user productivity learning.
   ...
   - Turn repeated patterns into better defaults, context routing, route
     choices, commercial-tier skill suggestions, workflow compression, and
     automation candidates.
   - Keep learned context inspectable, scoped, reversible, and governed by
...
- commercial-tier skill suggestions and skills-based OS productivity suite
