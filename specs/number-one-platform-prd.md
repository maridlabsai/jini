...
### 3a. Simplicity is the UX tenet

Every surface should make the user's next decision smaller and more obvious,
not expose Jini's internal machinery.

Simplicity does not mean hiding truth or removing expert control. It means:

- one obvious next action
- fewer visible choices until they matter
...
- command catalogs stay small and task-shaped
- the free tier must not ship the agent and skills OS productivity suite
- basic capability suggestions stay plain-language; named `skills`, `delegate`,
...
- any commercial agent interaction must return normal Jini results instead of
  orchestration logs
- advanced controls appear only when they protect trust, cost, recovery, or
  safety
- every new visible control must remove more friction than it adds
...
- watch packets must decide the next feature candidates, deletions, and
  roadmap changes rather than remain passive research
...
- Jini must learn user context, usage, habits, and repeated patterns from
  canonical work history, explicit feedback, and observed outcomes
- learning must make future work measurably more productive through fewer
  repeated prompts, better defaults, better route choices, faster continuation,
  and more accurate automation suggestions
- learned preferences must remain inspectable, scoped, reversible, and governed
  by approval and privacy policy
- repeated usage patterns must feed workflow compression, free-tier context
  routing, commercial-tier skill suggestions, and automation candidates
- productivity learning must be evaluated by time saved, rework avoided,
  interruptions avoided, cost reduced, and successful follow-through
